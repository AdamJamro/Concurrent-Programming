...
const NoOfProcesses = 5
const MinSteps = 20
const MaxSteps = 40

const MinDelay = 10 * millisecond //nanoseconds
const MaxDelay = 50 * millisecond //nanoseconds
...
var SectionLabels = [NoOfSections]string{"LOCAL_SECTION", "ENTRY_PROTOCOL", "CRITICAL_SECTION", "EXIT_PROTOCOL"}
