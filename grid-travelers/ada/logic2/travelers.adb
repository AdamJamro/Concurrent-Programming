...
-- -- Types, procedures and functions:
   ...
   function Get_Random_Position(Seed: Integer) return Position_Type is
      G : Generator;
      X : Integer;
      Y : Integer;
   begin
...
begin
   ...
   for I in Travel_Tasks'Range loop
      ...
      Used_Initial_Positions(Initial_Positions(I).X, Initial_Positions(I).Y) := true;
   end loop;

   for I in Travel_Tasks'Range loop
      Travel_Tasks(I).Init(I, Seeds(I+1), Symbol, Initial_Positions(I));
